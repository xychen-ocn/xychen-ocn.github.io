...
author_profile: true
header:
  overlay_image: /assets/images/site_banners/gentle_waves.jpeg
  overlay_filter: 0.1 # same as adding an opacity of 0.5 to a black background
  caption: ""
---

<!-- My research career so far has been influenced and shaped by personal values, curiosity, and some amount of luck. -->
...
I think good researchers always stay in learning mode. Following the trend of applying Machine Learning and Artificial Intelligence in Geosciences, I’m now learning to use this powerful new tool to uncover more hidden rules of the coupled ocean-atmosphere system from different data sources for the benefit of society.
